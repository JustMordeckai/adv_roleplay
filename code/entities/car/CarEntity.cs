...
public partial class CarEntity : Prop, IUse
{
	...
	protected override void OnDestroy()
	{
		...
		if ( driver is AdvRoleplay_Player player )
		{
			RemoveDriver( player );
		}
	}
	...
	public override void Simulate( Client owner )
	{
		...
		using ( Prediction.Off() )
		{
			...
			{
				if ( owner.Pawn is AdvRoleplay_Player player && !player.IsUseDisabled() )
				{
					RemoveDriver( player );
	...
	private void RemoveDriver( AdvRoleplay_Player player )
	{
		driver = null;
	...
	{
		if ( user is AdvRoleplay_Player player && player.Vehicle == null && timeSinceDriverLeft > 1.0f )
		{
			player.Vehicle = this;
	...
	public override void StartTouch( Entity other )
	{
		...
		if ( other is AdvRoleplay_Player player && player.Vehicle == null )
		{
	...
	protected override void OnPhysicsCollision( CollisionEventData eventData )
	{
		...
		if ( eventData.Entity is AdvRoleplay_Player player && player.Vehicle != null )
		{
			return;
		}
		...
		if ( speed > minImpactSpeed )
		{
			if ( eventData.Entity.IsValid() && eventData.Entity != this )
			{
				...
				if ( eventData.Entity.LifeState == LifeState.Dead && eventData.Entity is not AdvRoleplay_Player )
				{
